# Meteorology and Climatology Syllabus 11-20 Design

Date: 2026-07-07
Branch: meteo-syllabus-11-20

## Purpose

Continue the Meteorology and Climatology block as the largest remaining verified BOE-backed syllabus area after importing topics 1 through 10.

The current subset already contains Meteorology and Climatology topics 1 through 10 plus the full Mathematics and Physics blocks. This slice should extend the verified source-owned subset to cover Meteorology and Climatology topics 11 through 20 so the block continues to progress in controlled, reviewable batches.
...
- Meteorology and Climatology topics 11 through 20 must be copied from BOE Annex I
...
Included:
- Extend the checked-in BOE subset with Meteorology and Climatology topics `11` through `20`
- Make Meteorology and Climatology topics `1` through `20` present in the imported subset
...
- Add tests that assert the Meteorology and Climatology 1-20 batch is present in order
- Update docs to state that Meteorology and Climatology is partially imported through topic 20 while the overall syllabus is still partial

Excluded:
- Meteorology and Climatology topics `21` through `59`
...
- add topics `11` through `20`
- stop once the block reaches topic `20`
...
- imply that completing topics 1 through 20 means the entire syllabus is close to complete
...
- append Meteorology and Climatology topics `11` through `20` after topic `10`
...
- Meteorology and Climatology is partially imported through topic `20`
...
- two complete blocks
- one in-progress large block now extended through topic 20
- overall syllabus incomplete

## Testing

Add or extend coverage for:
- Meteorology and Climatology topics `1` through `20` present in order
...
- `docs/DATA_MODEL.md` if the current subset description needs to state that Meteorology and Climatology is imported through topic 20

The docs must clearly state:
- Meteorology and Climatology topics `1` through `20` are now imported from BOE Annex I
...
- the next recommended syllabus step is Meteorology and Climatology topics `21` onward in another controlled batch
- real past-exam import remains a separate value track

## Success Criteria

This slice is complete when:
- the checked-in BOE subset contains Meteorology and Climatology topics `1` through `20`
...
- tests prove the Meteorology and Climatology 1-20 sequence and still pass
